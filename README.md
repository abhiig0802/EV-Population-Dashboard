...
This dashboard explores EV adoption trends — covering manufacturer share, geographic distribution, model year trends, vehicle type split, and clean fuel eligibility — across a dataset of 130,443 registered electric vehicles.
...
├── DAV_25016654.twbx                      # Tableau packaged workbook
├── Electric_Vehicle_Population_Data.csv   # Source data
